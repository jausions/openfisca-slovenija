Thanks for contributing to OpenFisca! Please remove this line, as well as,
for each line below, the cases which are not relevant to your contribution :)
...
- Impact the OpenFisca-Slovenia public API (for instance renaming or removing a variable)
